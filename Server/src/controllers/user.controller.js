...
const registerUser = asyncHandler(async(req,res)=>{
    const {firstname,lastname,email,phone,selectedCountry,role,password} = req.body

    if([firstname,lastname,email,phone,selectedCountry,role,password].some((field)=>field?.trim()==="")){
    ...
    const user = await User.create({
        firstname,lastname,email,phone,location: selectedCountry,role,password
    })
